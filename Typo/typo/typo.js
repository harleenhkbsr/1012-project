    ...
    Typo = function (dictionary, affData, wordsData, settings) {
        ...
        if (dictionary) {
            ...
            // Loading data for Chrome extentions.
                ...
                if (!affData)
                    readDataFile("http://localhost:8000/Typo/typo/dictionaries/en_US/en_US.aff", setAffData);
                    
                
                if (!wordsData)
                    readDataFile("http://localhost:8000/Typo/typo/dictionaries/en_US/en_US.dic", setWordsData);
